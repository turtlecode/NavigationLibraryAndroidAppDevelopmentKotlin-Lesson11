package com.metehanfirat.navigationkotlin
...
class second_fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            val kullaniciAdi = second_fragmentArgs.fromBundle(it).username
            println(kullaniciAdi)
            textview2.text = kullaniciAdi
        }
        button2.setOnClickListener {
            val action = second_fragmentDirections.actionSecondFragmentToFirstFragment2()
